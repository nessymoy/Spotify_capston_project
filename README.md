...
## Limitations
Spotify wont allow to pull data mutliple time becuase of their securtiy reasons.
Airflow was a better choice than Amazon Redshift when laoding data. There are mutiple steps to follow when loaning dta in AWS S3 to Redshift hence leading to errors.
